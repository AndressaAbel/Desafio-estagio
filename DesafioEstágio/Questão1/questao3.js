function questao3() {
    ...
    const diasComFaturamento = faturamentoMensal.filter(dia => dia.valor > 0); //Isso me garante que foi um dia de funcionamento. A função filter elimina dias com valor = 0. //
  
    let menorFaturamento = Infinity;
    let maiorFaturamento = 0;
  
    for (let i = 0; i < diasComFaturamento.length; i++) {
      const valor = diasComFaturamento[i].valor;
    ...
    console.log("Média de faturamento:", mediaMensal);
    ...
    console.log("Menor faturamento diário:", menorFaturamento.toFixed(3));
    console.log("Maior faturamento diário:", maiorFaturamento.toFixed(1));
